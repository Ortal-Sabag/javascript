/*
transpile -
convet the syntax of one programming language to another.
In this case, language that is not really ever run anywhere, but instead are prossed by 'transpilers' that generate java script.

like typescript, traceur, 
